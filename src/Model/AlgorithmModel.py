...
class AlgorithmModel:
    """
     Critical parameters like the graph, algorithm, path_limit etc are initialized by this class. It has methods for registering observers, 
    setting algorithms, setting algorithm objects, printing route data and notifying observers, among other things. 
    """
    ...
    #If weight type is NORMAL return the length attribute of the edge; if the length attribute doesnt exist return weight attribute
    #And if the weight type is ElevationGain, return the difference in elevation b/n the two nodes.
    ...
    #By iterating over each pair of nodes in the route and adding the weight of the edge between them, 
    #this method determines the total weight of a particular route and returns the resulting total weight.
